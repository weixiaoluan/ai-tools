...
AI_CONFIG = {
    ...
    "api_base": os.getenv("AI_API_BASE", "https://apis.iflow.cn/v1"),
    "model": os.getenv("AI_MODEL", "TBStars2-200B-A13B"),
    "temperature": 0.7,
...
OAUTH_CONFIG = {
    ...
    "auth_url": os.getenv("OAUTH_AUTH_URL", "https://auth.iflow.cn/oauth/authorize"),
    "token_url": os.getenv("OAUTH_TOKEN_URL", "https://auth.iflow.cn/oauth/token"),
    "redirect_uri": os.getenv("OAUTH_REDIRECT_URI", "http://localhost:6066/api/auth/callback"),
    "scope": os.getenv("OAUTH_SCOPE", "read write"),
    "refresh_token": "",  # 从数据库动态加载
    "access_token": "",  # 从数据库动态加载
}
