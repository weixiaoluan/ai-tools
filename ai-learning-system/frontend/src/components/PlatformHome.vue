      ...
      <div class="tools-section">
        ...
        <div class="tools-grid">
          ...
          <div class="tool-card featured" @click="enterChat">
            <div class="tool-header">
              <div class="tool-icon">💬</div>
              <span class="tool-badge new">新功能</span>
            </div>
            <h3>AI 对话</h3>
            <p>智能对话助手，解答各类问题与疑惑，仿照Gemini风格设计</p>
            <div class="tool-features">
              <span>✓ 多轮对话</span>
              <span>✓ 流式响应</span>
              <span>✓ 上下文记忆</span>
            </div>
            <button class="btn btn-primary btn-block">开始对话 →</button>
          </div>
        </div>
      </div>
    </main>
...
function enterChat() {
  if (!apiConfigured.value) {
    showSettings.value = true
    statusMessage.value = '⚠️ 请先配置 API Key 才能使用AI对话'
    statusType.value = 'warning'
    return
  }
